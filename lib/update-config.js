...
module.exports = co.wrap(function * (webpackConfig, options) {
  ...
  if (options.static && options.static.from) {
  ...
  if (!options.dev) {
    ...
    loaderOptions.options.vue.loaders.css = ExtractTextPlugin.extract({
      fallbackLoader: 'vue-style-loader',
      loader: 'css-loader?sourceMap&-autoprefixer'
    })

    if (!options.cjs && !options.umd) {
      webpackConfig.output.filename = 'assets/[name].[chunkhash:8].js'
      webpackConfig.output.chunkFilename = 'assets/[id].[chunkhash:8].[name].js'
      webpackConfig.plugins.push(
