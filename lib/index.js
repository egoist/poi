  ...
  let webpackConfig = {
    ...
    resolve: {
      ...
      alias: {
        ...
        __WEBPACK_HOT_MIDDLEWARE_CLIENT__: `webpack-hot-middleware/client?path=http://${options.host}:${options.port}/__webpack_hmr&reload=true${options.hmrLog ? '' : '&noInfo=true'}`
      }
    },
    resolveLoader: {
      modules: [
