...
const getConfig = co.wrap(function * (config = {}) { // eslint-disable-line complexity
...
const vbuild = module.exports = co.wrap(function * (config) {
  console.log(chalk.bold('> Starting...'))

  const {webpackConfig, options} = yield getConfig(config)
